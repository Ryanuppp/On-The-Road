...
搜索结果中混有大量商业推广帖，**必须过滤后才能用于攻略引用**。只采信个人用户的真实体验帖。

#### 判定为广告/商业帖的特征（命中任一即排除）

| 维度 | 广告特征 |
|------|----------|
| **作者名** | 含"旅行社"、"总社"、"地接"、"包车"、"留子帮"等商业词汇（如"朋哥哥--金龙国际旅行总社"） |
| **标签** | 含 `#包车`、`#地接`、`#代办`、`#签证代办`、`#接送机` 等商业服务标签 |
| **内容风格** | 纯信息发布（排期表、价目表）而无个人体验叙述；文案过于精美、无真实细节；通篇正面无任何缺点 |
| **引流行为** | "加微信"、"私信联系"、"关注后踢我发"、"代购"、"代订"等引流话术 |
| **关联账号** | 内容中 @ 商家账号、或明确标注"合作"、"广告"、"赞助" |
| **重复发帖** | 同一作者反复发布同一目的地的推广内容（如每周发海参崴攻略的"本地博主"） |

#### 判定为个人用户的特征（需满足多项）

| 维度 | 个人特征 |
|------|----------|
| **叙述风格** | 第一人称、口语化、有时间线（"第一天…第二天…"） |
| **真实细节** | 具体价格、踩雷经历、天气体感、排队时长等不可能编造的细节 |
| **褒贬混合** | 既有推荐也有吐槽（"红菜汤不好喝"、"门票二十太坑了"） |
| **互动** | 评论区有真实问答互动，而非全是"已私"、"已加" |
| **发帖频率** | 账号并非只发某一目的地内容 |

#### 边界情况处理

- **个人帖中推荐特定商家**（如"找的东北小鱼儿，650/人"）→ 可以引用，但攻略中**不照搬商家联系方式**，只提取体验信息
- **留学生/长居者帖**（如作者名含"在俄国"、"留子"）→ 通常可信，但需检查是否有商业引流
- **高赞但疑似软广**（内容过于完美、无缺点、像写给品牌方的文案）→ 谨慎引用，交叉验证后再决定
